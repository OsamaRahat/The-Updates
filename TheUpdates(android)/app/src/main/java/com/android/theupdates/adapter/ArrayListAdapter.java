...
import com.android.theupdates.viewbinder.ViewBinder;
 ...
 * Android List view adapter. It can internally maintain an {@link java.util.ArrayList}
 * and provide certain operations that can be performed on {@link java.util.List}.
 *
 * @param <T>
...
public class ArrayListAdapter<T> extends BaseAdapter implements SpinnerAdapter {
	...
	public void addAll(List<T> entityList,int index ) {
		arrayList.addAll(index,entityList);
		notifyDataSetChanged();
	}
