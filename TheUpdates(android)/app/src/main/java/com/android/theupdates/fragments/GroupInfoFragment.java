...
public class GroupInfoFragment extends BaseFragment implements View.OnClickListener, commentCallBack, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static GroupInfoFragment getInstance(SideBarItem sideBarItemObj) {
        Bundle bundle = new Bundle();
        bundle.putParcelable(UPDATE_OBJ, sideBarItemObj);
        GroupInfoFragment group = new GroupInfoFragment();
    ...
    private void getPostList() {
        ...
        Call<WebResponseList<PostItem>> response = getWebServiceInstance().getPosts(getUserId(), sideBarItemObj.getId() + "", offset);
