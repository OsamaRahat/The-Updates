...
public class WeatherAdminFragment extends BaseFragment implements View.OnClickListener, commentCallBack, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static WeatherAdminFragment getInstance(SideBarItem sideBarItemObj) {
        Bundle bundle = new Bundle();
        bundle.putParcelable(UPDATE_OBJ, sideBarItemObj);
        WeatherAdminFragment group = new WeatherAdminFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        relShareContainer.setVisibility(View.GONE);
        txtShareUpdate.setText("What is your "+sideBarItemObj.getStrCaption());
    ...
    private void getPostList() {
        ...
        Call<WebResponseList<PostItem>> response = getWebServiceInstance().getPosts(getUserId(), sideBarItemObj.getId() + "", offset,"2");
